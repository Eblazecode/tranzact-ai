...
def ecobank_preprocessing(file_path: str, user_name: str, bank_name: str) -> pd.DataFrame:
    """
    Preprocess Ecobank statement into standardized 8-column format.
    
    Args:
        file_path: Path to Ecobank statement file
        user_name: Name of the user for file naming
        bank_name: Name of the bank (Ecobank)
    ...
    BETTING_KEYWORDS = [
        ...
        'BETWAY', 'BETBONANZA', 'NAIRABET', 'MSPORT',
        'BETANO', 'BETWINNER', 'PARIPESA', 'MELBET',
        'MEGAPARI', '22BET', 'BETPAWA', 'LIVESCOREBET',
        'MOZZARTBET', 'WAZOBET', 'ACCESSBET', 'BETFAIR',
        'BETLAND', 'GREENLOTTO', 'AFRIBET', 'ZEBET',
        'FOOTBALLING',
    ]
    ...
    try:
        ...
        # Final dataframe with standard columns
        ...
        raise ValueError(f"Could not process Ecobank file: {e}")
